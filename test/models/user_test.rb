...
class UserTest < ActiveSupport::TestCase
  ...
  test "should follow and unfollow a user" do
    dorian = users(:dorian)
    archer  = users(:archer)
    assert_not dorian.following?(archer)
    dorian.follow(archer)
    assert dorian.following?(archer)
    assert archer.followers.include?(dorian)
    dorian.unfollow(archer)
    assert_not dorian.following?(archer)
  end

  test "feed should have the right posts" do
    michael = users(:dorian)
    archer  = users(:archer)
    lana    = users(:lana)
